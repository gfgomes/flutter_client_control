...
class _ClientsPageState extends State<ClientsPage> {
            ...
            itemBuilder: (context, index) {
              return Dismissible(
                ...
                onDismissed: (direction) {
                  list.remove(list.clients.removeAt(index));
                },
              );
            },
          );
  ...
  void createType(context) {
    ...
    ClientType dropdownValue =
        Provider.of<Types>(context, listen: false).listTypes[0];
        ...
        builder: (BuildContext context) {
          return AlertDialog(
                  ...
                  children: <Widget>[
                    ...
                    StatefulBuilder(
                      ...
                      return DropdownButton(
                        ...
                        items: Provider.of<Types>(context, listen: false)
                            .listTypes
                            .map((ClientType type) {
            ...
            actions: [
              Consumer<Clients>(
                builder:
                    (BuildContext context, Clients clients, Widget? child) {
                  return TextButton(
